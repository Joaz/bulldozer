...
parts = [BulldozerGearbox,BulldozerRodHolder,BulldozerIdler, BulldozerArmBearingSupport, BulldozerAcmeNutHolder,ZAcmeBearingHolderLower,ZAcmeBearingHolderUpper,XCarriage,ZLinearBearingHolder,YMotorMount,YBearingHolder,XAxisAcmeNutHolder, XAxisMountingPart,YBeltHolder,YBeltIdler,YRodHolder,ZMotorMount,ZRodHolder,XBeltIdler]
