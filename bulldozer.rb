...
assemblies = [ExtruderMountAssembly,BottomPlate,ExtruderAssembly,MicroswitchRrd,XEndMotor,ZEndstop,YEndstop,PrinterAssembly,YzBracket,YZAxisAssembly,XAxisAssembly,YAxisAssembly,ZAxisAssembly,YMotorMount,TSlotMount,YRodHolder,BedPlate,SHF12,PSU_sp320_12,YBearingHolder]
